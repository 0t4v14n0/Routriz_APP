...
export default function LandingPage() {
    ...
    const msgWhatsApp = encodeURI("Olá! Gostaria de testar o Routriz em Pernambuco.");
        ...
        <div className="min-h-screen bg-gray-50 font-sans text-gray-800 flex flex-col">
            ...
            >
                ...
                <div className="max-w-3xl mx-auto relative z-10 flex flex-col items-center gap-6">
                    <span className="bg-yellow-500 text-blue-900 px-5 py-1.5 rounded-full text-sm font-extrabold tracking-widest uppercase mb-2 shadow-lg">
                        📍 Exclusivo para Pernambuco
                    </span>
                    ...
                    <p className="text-lg md:text-xl text-blue-100 font-medium max-w-2xl drop-shadow">
                        O roteirizador feito sob medida para as ruas de Pernambuco. Leia etiquetas com a câmera e calcule a melhor rota em segundos, da Região Metropolitana ao Sertão.
                    </p>
                    ...
                    <p className="text-sm text-blue-200 mt-2 font-medium drop-shadow">Disponível para motoristas de PE.</p>
                </div>
            </section>
                    ...
                    {!isBackendOnline ? (
                        <div className="max-w-md w-full mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border-2 border-green-500 relative transform hover:-translate-y-1 transition-transform">
                            ...
                            <div className="p-8 text-center">
                                ...
                                <p className="text-gray-500 text-sm mb-8">Estamos liberando vagas exclusivas para entregadores que atuam em Pernambuco. Entre em contato.</p>
            ...
            <footer className="bg-gray-900 text-gray-400 py-8 text-center text-sm mt-auto">
                <div className="max-w-6xl mx-auto px-5 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <p>&copy; {new Date().getFullYear()} Routriz. Feito com orgulho em Pernambuco.</p>
